...
export default function FestivalSlideshow() {
  return (
    <section className="bg-gradient-to-br from-orange-300/75 via-orange-500/85 to-red-500/80 text-white py-20 px-6 sm:px-12 lg:px-24">
      ...
      <p className="mt-10 text-center text-sm text-orange-100">
  Images generated by <strong>YonderWonder.ai</strong>. Input images of individuals courtesy of <a href="https://freepik.com" className="underline hover:text-white" target="_blank">freepik.com</a> and <a href="https://pexels.com" className="underline hover:text-white" target="_blank">pexels.com</a>.
</p>
    </section>
  );
}
